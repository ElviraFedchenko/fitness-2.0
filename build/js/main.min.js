...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _vendor.checkReviewsSwiper)();
  (0, _vendor.checkTrainerSwiper)();
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  function setupVideo() {
    var link = video.querySelector('.content__link');
    var button = video.querySelector('.content__button');
...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./utils/ios-vh-fix":13,"./vendor.js":15,"./vendor/init-accordion":18,"./vendor/init-tabs":19}],2:[function(require,module,exports){
"use strict";
...
exports.checkTrainerSwiper = exports.checkReviewsSwiper = void 0;
require("./vendor/swiper");
require("./vendor/focus-visible-polyfill");
require("./vendor/tabs");
require("./vendor/init-tabs");
// Swiper 7.4.1

var trainerSwiper = document.querySelector('.trainer__slider');
var reviewsSwiper = document.querySelector('.reviews__slider');
var checkTrainerSwiper = function checkTrainerSwiper() {
  if (trainerSwiper) {
...
exports.checkTrainerSwiper = checkTrainerSwiper;
...
exports.checkReviewsSwiper = checkReviewsSwiper;

},{"./vendor/focus-visible-polyfill":17,"./vendor/init-tabs":19,"./vendor/swiper":20,"./vendor/tabs":21}],16:[function(require,module,exports){
"use strict";
